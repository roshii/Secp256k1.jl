@testset "secp256k1 Tests" begin
    ...
    @testset "scep256k1" begin
        ...
        @testset "Order" begin
            point = secp256k1.N * secp256k1.G
            @test typeof(point) == S256Point{secp256k1.Infinity}
        end
